...
import one.chandan.rubato.databinding.DialogHomeRearrangementBinding;
import one.chandan.rubato.ui.adapter.HomeSectorHorizontalAdapter;
import one.chandan.rubato.viewmodel.HomeRearrangementViewModel;
