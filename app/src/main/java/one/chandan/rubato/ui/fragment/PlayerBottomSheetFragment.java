...
import one.chandan.rubato.databinding.FragmentPlayerBottomSheetBinding;
...
import one.chandan.rubato.ui.fragment.pager.PlayerControllerVerticalPager;
    ...
    private void setMetadata(MediaMetadata mediaMetadata) {
        if (mediaMetadata.extras != null) {
            ...
            CustomGlideRequest.Builder
                    .from(requireContext(), mediaMetadata.extras.getString("coverArtId"), CustomGlideRequest.ResourceType.NowPlaying)
                    .build()
