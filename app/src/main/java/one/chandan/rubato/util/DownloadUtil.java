...
public final class DownloadUtil {
    ...
    public static final String DOWNLOAD_NOTIFICATION_SUCCESSFUL_GROUP = "one.chandan.rubato.SuccessfulDownload";
    public static final String DOWNLOAD_NOTIFICATION_FAILED_GROUP = "one.chandan.rubato.FailedDownload";
