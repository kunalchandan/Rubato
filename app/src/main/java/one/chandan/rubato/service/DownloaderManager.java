...
public class DownloaderManager {
    ...
    public void download(List<MediaItem> mediaItems, List<one.chandan.rubato.model.Download> downloads) {
        for (int counter = 0; counter < mediaItems.size(); counter++) {
            download(mediaItems.get(counter), downloads.get(counter));
        }
    }

    public void remove(MediaItem mediaItem, one.chandan.rubato.model.Download download) {
    ...
    public void remove(List<MediaItem> mediaItems, List<one.chandan.rubato.model.Download> downloads) {
        for (int counter = 0; counter < mediaItems.size(); counter++) {
    ...
    public static String getDownloadNotificationMessage(String id) {
        one.chandan.rubato.model.Download download = getDownloadRepository().getDownload(id);
    ...
    private static void insertDatabase(one.chandan.rubato.model.Download download) {
